...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo"</td></tr>";
    echo "<tr><td><b>Dose given within 24 hour : ";
    echo"</td></tr>";
    ...
    echo"</td></tr>";
    echo"<tr><td><b>Doses in 1st month : ";
    echo"</td></tr>";
    ...
    echo"</td></tr>";
    echo"<tr><td><b>Doses in 2nd month : ";
    echo"</td></tr>";
    ...
    echo"</td></tr>";
    echo"<tr><td><b>Doses between 16-24 month : ";
    echo"</td></tr>";
    ...
    echo"</td></tr>";
    echo"<tr><td><b>Doses of Vitamin-A (24-60) months : ";
    echo"</td></tr>";
    ...
    echo"</td></tr>";
    echo"<tr><td><b>Doses between 5-6 years : ";
    echo"</td></tr>";
    ...
    echo"</td></tr>";
    echo"<tr><td><b>Doses in 16th year : ";
    echo"</td></tr>";
